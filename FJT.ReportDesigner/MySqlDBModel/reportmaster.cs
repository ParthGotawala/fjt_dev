...
namespace FJT.ReportDesigner.MySqlDBModel
{
    public class reportmaster
    {
        public reportmaster()
        {
            ...
            //reportviewerparameters = new HashSet<reportviewerparameter>();
            reportmasterparameters = new HashSet<reportmasterparameter>();
        }
        ...
        public bool radioButtonFilter { get; set; }
        ...
        //public virtual ICollection<reportviewerparameter> reportviewerparameters { get; set; }
        public virtual ICollection<reportmasterparameter> reportmasterparameters { get; set; }
    }
}
