...
{
    public  class Part_CleanArrowRequestHandler: IPart_CleanArrowRequestHandler
    {
        IModel channel = null;
        string partServiceQueue = ConfigurationManager.AppSettings["PartCleanARQueue"].ToString();
