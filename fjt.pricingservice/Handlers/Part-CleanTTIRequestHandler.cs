...
{
    public class Part_CleanTTIRequestHandler:IPart_CleanTTIRequestHandler
    {
        IModel channel = null;
        string partServiceQueue = ConfigurationManager.AppSettings["PartCleanTTIQueue"].ToString();
