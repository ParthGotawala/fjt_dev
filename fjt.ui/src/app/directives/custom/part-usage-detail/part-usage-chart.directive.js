(function () {
    ...
    /* @ngInject */
    angular.module('app.core').directive('partUsageChart', function (WidgetFactory, BaseService, WIDGET) {
        return {
            restrict: 'E',
            templateUrl: 'app/directives/custom/part-usage-detail/part-usage-chart.html',
            scope: {
                chartDataList: '=',
                chartType: '='
            },
                ...
                scope.$watch('chartDataList', function (newVal, oldVal) {
                    if (newVal && newVal.chartSetting) {
                        ...
                        if (newVal.chartSetting.seriesdata) {
                          ...
                          //  seriesColorList = newVal.chartSetting.seriesColor.split(',');
                        }
                    ...
                    if (chartData.length == 0) {
                        ...
                        chartData.forEach(function (item) {
                            ...
                            seriesPropList.forEach(function (prop) {
                                ...
                                seriesObj.data.push({
                                    name: item[chatSetting.xAxisVal],
                                    //color: seriesColorList[seriesPropList.indexOf(prop)],
                                    y: item[prop] || 0,
                                    drilldown: false,
                ...
                function getSeries(prop, seriesName) {
                    ...
                    if (seriesObj)
                        ...
                        if (chartType == WIDGET.CHART_NAME.PIE) {
                            ...
                            obj.events = {
                                mouseOver: function () {
                                    // display current series datalables only
