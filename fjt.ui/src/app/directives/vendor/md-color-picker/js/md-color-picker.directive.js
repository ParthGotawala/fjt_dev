...
; (function (angular, window, tinycolor) {
  ...
  (function (window, angular, undefined) {
    ...
    angular.module('mdColorPicker', [])
      ...
      .directive('mdColorPicker', ['$timeout', 'mdColorPickerHistory', function ($timeout, colorHistory) {
        ...
        return {
          templateUrl: "app/directives/vendor/md-color-picker/templates/mdColorPicker.tpl.html",
      ...
      .directive('mdColorPickerContainer', ['$compile', '$timeout', '$mdColorPalette', 'mdColorPickerHistory', function ($compile, $timeout, $mdColorPalette, colorHistory) {
        return {
          templateUrl: 'app/directives/vendor/md-color-picker/templates/mdColorPickerContainer.tpl.html',
          scope: {
            value: '=?',
            default: '@',
            random: '@',
          ...
          controller: ["$scope", "$element", "$attrs", function ($scope, $element, $attrs) {
            ...
            _.each($mdColorPalette, (item, cname) => {
              _.each(item, (color, idx) => {
                if (new tinycolor(color.hex).isDark())
                  delete item[idx];
              });
            });
            ...
            */
            ...
            function createDOM() {
              ...
              angular.forEach(scope.materialPalette, function (value, key) {
                ...
                title.css({
                  height: '75px',
                  backgroundColor: 'rgb(' + value['50'].value[0] + ',' + value['50'].value[1] + ',' + value['50'].value[2] + ')'
                });
                if (!scope.isDark(value['50'].value)) {
                  title.addClass('dark');
                }
      ...
      .factory('$mdColorPicker', ['$q', '$mdDialog', 'mdColorPickerHistory', 'DialogFactory', 'CORE', function ($q, $mdDialog, colorHistory, DialogFactory, CORE) {
        var dialog;
        ...
        return {
          show: function (options) {
            ...
            dialog = $mdDialog.show({
              templateUrl: 'app/directives/vendor/md-color-picker/templates/mdColorPickerDialog.tpl.html',
              ...
              controller: ['$scope', 'options', function ($scope, options) {
                ...
                $scope.ok = function ok() {
                  //if (!new tinycolor($scope.value).isDark()) {
                  // readability Analyze the 2 colors and returns the color contrast
                  let colorContrast = tinycolor.readability('#000', new tinycolor($scope.value))                  
                  if (colorContrast > 3) {
                    if (CORE.SUCCESS_RGB_COLOR == $scope.value || CORE.ERROR_RGB_COLOR == $scope.value || CORE.NON_ROHS_RGB_COLOR == $scope.value) {
                      var model = {                       
                        messageContent : angular.copy(CORE.MESSAGE_CONSTANT.DYNAMIC_MESSAGE.GLOBAL.VALIDCOLOR),
                        multiple: true
                      }
                    ...
                    var model = {                      
                      messageContent: angular.copy(CORE.MESSAGE_CONSTANT.DYNAMIC_MESSAGE.GLOBAL.DARKCOLOR),
                      multiple: true
                    }
                    DialogFactory.messageAlertDialog(model);
                  }
  ...
  angular.module("mdColorPicker").run(["$templateCache", function ($templateCache) {
    $templateCache.put("app/directives/vendor/md-color-picker/templates/mdColorPicker.tpl.html",
    ...
    <md-input-container flex>\n	\
    	...
    	<input readonly=\"readonly\" type=\"input\" ng-model=\"value\" class=\'md-color-picker-input\'  ng-mousedown=\"(openOnInput || !mdColorPreview) && showColorPicker($event)\"/>\n	\
    </md-input-container>\n	\
    ...
    $templateCache.put("app/directives/vendor/md-color-picker/templates/mdColorPickerContainer.tpl.html", "<div class=\"md-color-picker-container in\" layout=\"column\">\n	\
    ...
    $templateCache.put("app/directives/vendor/md-color-picker/templates/mdColorPickerDialog.tpl.html",
      "<md-dialog class=\"cm-color-picker-dialog md-color-picker-dialog\" layout=\"row\">\n	\
        <div class=\"cm-section-main\" layout-wrap flex=\"100\">\n	\
            <div class=\"cm-color-picker cm-section-header\" flex=\"100\">\n	\
                   <h2>Colorcode Preview</h2>\n	\
            </div>\n	\
            <div class=\"cm-color-picker cm-section-inner\" flex=\"100\">\n	\
                    ...
                    <tbody>\n	\
                        <tr>\n	\
                            <th>\n	\
                              <span class=\"label-container\">\n	\
                               ...
                               <label class=\"margin-2 label-box\" ng-style=\"{'height':'24px','background-color': value}\">\n	\
                                </label>\n	\
                            </th>\n	\
                        </tr>\n	\
                        <tr>\n	\
                        ...
                        <tr>\n	\
                            <th>\n	\
                               <span class=\"label-container\">\n	\
                                ...
                                <md-button name=\"colorCode\" class=\"md-default md-raised black-500-fg margin-0\"\n	\
                                        style=\"background-color:{{value}} !important\">{{value}}</md-button>\n	\
                            </th>\n	\
                        </tr>\n	\
                         <tr>\n	\
                            <th class=\"cm-tr\">\n	\
                        ...
                        <tr>\n	\
                            <th>\n	\
                               ...
                               <label class=\"margin-2 label-box\" ng-style=\"{'color':'rgba(255,255,255,1)','background-color': value}\">\n	\
                                    <md-tooltip ng-if=\"value\">{{value}}</md-tooltip>\n	\
                                    {{value}}\n	\
                                </label>\n	\
                            </th>\n	\
                        </tr>\n	\
                        ...
                        <tr>\n	\
                            <th>\n	\
                               <span class=\"label-container\">\n	\
                                ...
                                <div class=\"cm-custom-handsontable-td\" ng-style=\"{'font-weight': 'normal','background-color': value}\">{{value}}</div>\n	\
                            </th>\n	\
                        </tr>\n	\
                        <tr>\n	\
                            <th class=\"cm-tr\">\n	\
                        ...
                        <tr>\n	\
                            <th>\n	\
                               <span class=\"label-container\">\n	\
                                ...
                                <div class=\"cm-custom-handsontable-td handsontable\" ng-style=\"{'font-weight': 'normal','background-color': value}\"><span class=\"htDimmed\">{{value}}</span></div>\n	\
                            </th>\n	\
                        </tr>\n	\
                         <tr>\n	\
                            <th class=\"cm-tr\">\n	\
                        ...
                        <tr>\n	\
                            <th>\n	\
                                <div style=\"background-color:rgb(3,155,229) !important\">\n	\
                                    <span class=\"label-container\">\n	\
                                        Header Preview\n	\
                                    </span><br/>\n	\
                                    <label class=\"margin-2 label-box\" ng-style=\"{'color':'rgba(255,255,255,1)','background-color': value}\">\n	\
