      ...
      aOnSelectAction: function (event, $element, editorScope) {
        ...
        reLinkButton.on('click', function (event) {
          ...
          if (urlLink && urlLink !== '' && urlLink !== 'http://') {
            //[S] Dharam: 04/01/2020 [If link and link value is same then at the time of update set link value]
            if ($element.html() == $element.attr('href')) {
              $element.html(urlLink);
            }
            //[E] Dharam: 04/01/2020 [If link and link value is same then at the time of update set link value]
        ...
        targetToggle.on('click', function (event) {
          ...
          targetToggle.toggleClass('active');
            //[S] Dharam: 04/01/2020 [Resolved issue of open link in new tab]
          window.open($element[0].href);
            //[e] Dharam: 04/01/2020 [Resolved issue of open link in new tab]
          editorScope.updateTaBindtaTextElement();
        });
  ...
  .run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sanitize', 'taOptions', '$log',
    function (taRegisterTool, $window, taTranslations, taSelection, taToolFunctions, $sanitize, taOptions, $log) {
      ...
      taRegisterTool('indent', {
        ...
        //commandKeyCode: 'TabKey' [Dharam: 04/02/2020] Restrict tab event for indent
      });
