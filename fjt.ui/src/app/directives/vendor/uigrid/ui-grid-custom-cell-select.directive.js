          ...
          post: function ($scope, $elm, $attrs, uiGridCtrl) {
            ...
            function dragStart(evt) {
              if (angular.element(evt.target).hasClass('ui-grid-cell-contents')) {
                ...
                /** If condition added by Dharam on 11/22/2019, to resolve issue while click out side checkbox it generates console error*/
                if (cellData) {
            ...
            function setSelectedStates() {
              ...
              /*Dharam[12/14/2019]: To resolve issus of console error while clicking on footer cell*/
            ...
            function createCopyData(cells, numCols) {
              ...
              for (var i = 0; i < cells.length; i++) {
                ...
                var cellValue = currentCell.rowCol.row ? grid.getCellDisplayValue(currentCell.rowCol.row, currentCell.rowCol.col) : '';
