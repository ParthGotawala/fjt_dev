    ...
    return {
      ...
      link: function postLink($scope, element) {
        ...
        var startWebcam = function startWebcam() {
          ...
          var mediaConstraint = {
            video: {
              facingMode: $scope.isAccessBackCamera ? { exact: 'environment' } : 'user'
            }, audio: false
          };
          ...
          if (window.hasModernUserMedia) {
            ...
            navigator.mediaDevices.getUserMedia(mediaConstraint, onSuccess, onFailure);
          }
        ...
        function getDeviceList() {
          navigator.mediaDevices.enumerateDevices().then((devices) => {
            $scope.devices = devices.filter(device => device.kind === 'videoinput');
            if ($scope.devices && $scope.devices.length > 1) {
              $scope.isAccessBackCamera = true;
            } else {
              $scope.isAccessBackCamera = false;
            }
          })
        }
        getDeviceList();
        ...
        $scope.$watch('isAccessBackCamera', (newValue, oldValue) => {
